...
class Game:
    ...
    def move_left(self):
        if self.field.is_valid_position(
            self.active_brick, self.active_brick.row, self.active_brick.col - 1
        ):
    ...
    def drop(self):
        ...
        while self.field.is_valid_position(
            self.active_brick, self.active_brick.row + 1, self.active_brick.col
        ):
